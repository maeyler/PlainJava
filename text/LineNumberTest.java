...
public class LineNumberTest extends JPanel implements Scrollable {
   ...
   public LineNumberTest(JTextArea t) {
   ...
   public static LineNumberTest addLineNumbers(JTextArea t)  {
      return new LineNumberTest(t);
   }
   public static LineNumberTest main()  {
      JFrame frm = new JFrame("Test LineNumberPane"); 
      int d = exit? 
      	 JFrame.EXIT_ON_CLOSE : JFrame.DISPOSE_ON_CLOSE;
      frm.setDefaultCloseOperation(d);
      LineNumberTest p = new LineNumberTest();
